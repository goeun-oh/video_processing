...
#set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { image_mode4[0]  }]; #IO_L5P_T0_34               ,Sch=SW8
#set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { image_mode4[1] }]; #IO_L2N_T0_34               ,Sch=SW9
#set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { image_mode3[0] }]; #IO_L1N_T0_34               ,Sch=SW10
#set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { image_mode3[1] }]; #IO_L2P_T0_34               ,Sch=SW11
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { image_mode4 }]; #IO_L5N_T0_34               ,Sch=SW12
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { image_mode3 }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { image_mode2  }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { image_mode1 }]; #IO_L1P_T0_34               ,Sch=SW15
...
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { btn_reset }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND


##Pmod Header JA

set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { buzz}]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
...
set_property -dict { PACKAGE_PIN P19  IOSTANDARD LVCMOS33 } [get_ports { vga_h_sync }]; #IO_L10P_T1_D14_14     ,Sch=VGA_HS
set_property -dict { PACKAGE_PIN R19  IOSTANDARD LVCMOS33 } [get_ports { vga_v_sync }]; #IO_L10N_T1_D15_14     ,Sch=VGA_VS
