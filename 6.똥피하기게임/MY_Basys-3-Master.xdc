...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { collision_detected }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { game_over }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { collision_detected }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
...
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { reset_button }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { start_button }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
...
set_property -dict { PACKAGE_PIN A17  IOSTANDARD LVCMOS33 } [get_ports { xclk }]; #IO_L12N_T1_MRCC_16 ,Sch=JB8
set_property -dict { PACKAGE_PIN C15  IOSTANDARD LVCMOS33 } [get_ports { href}]; #IO_L11P_T1_SRCC_16 ,Sch=JB9
