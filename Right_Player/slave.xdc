...
set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports { o_scl }]; #IO_L2P_T0_AD12P_35    ,Sch=JA9
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { o_sda }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
