...
## Switches
# set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { zoom_sw[2] }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
# set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { zoom_sw[3]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
# set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { zoom_sw[1]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
# set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { zoom_sw[0]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
...
#set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { brightness_sw[0] }]; #IO_L5N_T0_34               ,Sch=SW12
#set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { brightness_sw[1] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
#set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { brightness_sw[2] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
#set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { brightness_sw[3] }]; #IO_L1P_T0_34               ,Sch=SW15
...
set_property -dict { PACKAGE_PIN A16  IOSTANDARD LVCMOS33 } [get_ports { ov7670_v_sync }]; #IO_L12P_T1_MRCC_16 ,Sch=JB2
