...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { SCL_pl_from_pr }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports { SDA_pl_from_pr }]; #IO_L5N_T0_AD13N_35    ,Sch=JA2
